...
<div class="loginBox">	
	...
	<div class="login_cont">
		<ul class="login">
			...
			<li class="mb_10"><input type="text" name="username" required="required" class="login_input user_icon"></li>
			<li class="l_tit">密码</li>
			<li class="mb_10"><input type="password" name="password" required="required" class="login_input user_icon"></li>
			<li class="mb_10"><input type="checkbox" name="rememberMe"> 记住我 </li>
